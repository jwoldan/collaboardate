...
class HomeCreateMenuBoard extends ToggleMenu {
  render() {
    const menuContent = <BoardCreateFormContainer toggle={this.toggle} show={this.props.show} />;
      ...
      <section>
        <a onClick={this.toggle}>
          ...
          <span className="quiet small">
            A board is a collection of cards ordered in a list of lists. Use it to manage a project,
            track a collection, or organize anything.
          </span>
        </a>
