...
class HomeBoardsMenu extends ToggleMenu {
  render() {
    ...
    const menuContent = (
      <section>
        <HomeBoardsMenuList title="Personal Boards" boards={personalBoards} toggle={this.toggle} />
        <HomeBoardsMenuList title="Shared Boards" boards={sharedBoards} toggle={this.toggle} />
      </section>
    );
